...
<selector>
  <div class="human-body">
    <svg
      class="head"
      on:click={() => activateArea("head")}
      on:keydown={() => activateArea("head")}
      data-position="head"
    ...
    <svg
      class="shoulder"
      on:click={() => activateArea("shoulder")}
      on:keydown={() => activateArea("shoulder")}
    ...
    <svg
      class="arm"
      on:click={() => activateArea("arm")}
      on:keydown={() => activateArea("arm")}
      data-position="arm"
      xmlns="http://www.w3.org/2000/svg"
      width="156.344"
      height="119.25"
    ...
    <svg
      class="chest"
      on:click={() => activateArea("chest")}
      on:keydown={() => activateArea("chest")}
      data-position="chest"
      xmlns="http://www.w3.org/2000/svg"
      width="86.594"
      height="45.063"
    ...
    <svg
      class="stomach"
      on:click={() => activateArea("stomach")}
      on:keydown={() => activateArea("stomach")}
    ...
    <svg
      class="legs"
      on:click={() => activateArea("legs")}
      on:keydown={() => activateArea("legs")}
      data-position="legs"
      xmlns="http://www.w3.org/2000/svg"
      width="93.626"
      height="286.625"
    ...
    <svg
      class="hands"
      on:click={() => activateArea("hands")}
      on:keydown={() => activateArea("hands")}
      data-position="hands"
      xmlns="http://www.w3.org/2000/svg"
      width="205"
      height="38.938"
