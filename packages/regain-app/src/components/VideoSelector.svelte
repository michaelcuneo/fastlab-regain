<script lang="ts">
  ...
  import { difficult, pain, userExercises, type exerciseType } from "../utils/store";
  import { calculateRealTime } from "../utils/helpers";
              ...
              >
                ...
                <Content style="padding: 1rem;">
                  <subtitle>
                    ...
                    <time>
                      {calculateRealTime(exercise.time)}<Icon
                        class="material-icons">timer</Icon
                      >
                    </time>
                  </subtitle>
                </Content>
