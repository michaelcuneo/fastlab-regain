<script>
  ...
  import { onboard } from '../utils/store.js';
  ...
  const activateArea = async area => {
    switch(area) {
      case 'head':
        activeAreas.head = !activeAreas.head;
        break;
      case 'shoulder':
        activeAreas.shoulder = !activeAreas.shoulder;
        break;
      case 'arm':
        activeAreas.arm = !activeAreas.arm;
        break;
      case 'chest':
        activeAreas.chest = !activeAreas.chest;
        break;
      case 'stomach':
        activeAreas.stomach = !activeAreas.stomach;
        break;
      case 'legs':
        activeAreas.legs = !activeAreas.legs;
        break;
      case 'hands':
        activeAreas.hands = !activeAreas.hands;
      default:
        return;
    }
    activeAreas.area == !activeAreas.area;
  };
...
<selector>
  ...
  <div class="legend">
    <Button variant="raised" on:click={handleSave}>SAVE AREAS</Button>
  </div>
</selector>
